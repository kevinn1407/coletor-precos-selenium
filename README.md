...
Usei o books.toscrape.com, um site feito de propósito pra praticar scraping. Escolhi ele em vez de uma loja real porque é estável, não bloqueia robôs e é liberado pra esse uso, então o projeto sempre funciona quando alguém for testar.
